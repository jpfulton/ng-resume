...
export const b2cPolicies = {
    ...
    authorities: {
        signUpSignIn: {
            authority: 'https://jpatrickfulton.b2clogin.com/jpatrickfulton.onmicrosoft.com/b2c_1_susi',
        },
        resetPassword: {
            authority: 'https://jpatrickfulton.b2clogin.com/jpatrickfulton.onmicrosoft.com/B2C_1_reset',
        },
        editProfile: {
            authority: 'https://jpatrickfulton.b2clogin.com/jpatrickfulton.onmicrosoft.com/b2c_1_profile',
        },
    },
...
export const msalConfig: Configuration = {
    auth: {
        // clientId: '350c6199-8611-4437-b38f-2d2270a50052', // This is the ONLY mandatory field that you need to supply.
        clientId: "1e252383-1c48-435a-aec9-df0ef58744b6",
