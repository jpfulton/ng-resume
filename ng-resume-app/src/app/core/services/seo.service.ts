...
export class SeoService {
  ...
  updateSeoHeaderTags(
    ...
    allowRobotIndexing: boolean = true,
  ): void {
    ...
    const metaTagDefinitions: MetaDefinition[] = this.createMetaDefinitions(
      config,
      allowRobotIndexing,
    );
  ...
  private createMetaDefinitions(
    ...
    definitions.push(
      ...this.createStandardMetaDefinitions(config, allowRobotIndexing),
    );
  ...
  private createStandardMetaDefinitions(
    config: SeoConfig,
    allowRobotIndexing: boolean = true,
  ): MetaDefinition[] {
    const definitions: MetaDefinition[] = [
      ...
      {
        name: "robots",
        content: allowRobotIndexing ? "index, follow" : "noindex",
      },
    ];
